...
public class EMGDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Project>()
            .HasMany(p => p.ProducerServices)
            .WithMany(ps => ps.Projects)
            .UsingEntity<Dictionary<string, object>>(
                "ProjectServices",
                j => j.HasOne<ProducerService>().WithMany().HasForeignKey("ProducerServiceId"),
        ...
        modelBuilder.Entity<Project>().HasData(new Project[]
            {
                new Project
                {
                    ...
                    CompleteDate = new DateTime(2023, 06, 30),
                    IsComplete = true,
                    KeyId = 1,
                    Bpm = 120,
                ...
                new Project
                {
                    ...
                    CompleteDate = new DateTime(2023, 08, 15),
                    IsComplete = true,
                    KeyId = 2,
                    Bpm = 128,
                ...
                new Project
                {
                    ...
                    CompleteDate = new DateTime(2023, 09, 20),
                    IsComplete = true,
                    KeyId = 3,
                    Bpm = 110,
                ...
                new Project
                {
                    ...
                    CompleteDate = new DateTime(2023, 12, 01),
                    IsComplete = true,
                    KeyId = 6,
                    Bpm = 118,
                ...
                new Project
                {
                    ...
                    CompleteDate = new DateTime(2024, 02, 20),
                    IsComplete = true,
                    KeyId = 8,
                    Bpm = 132,
                ...
                new Project
                {
                    ...
                    CompleteDate = new DateTime(2024, 03, 25),
                    IsComplete = true,
                    KeyId = 9,
                    Bpm = 115,
